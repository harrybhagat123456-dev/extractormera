                    ...
                    for cdata in data:
                        try:
                            ...
                            for video in videos:
                                ...
                                vid_date = extract_date(video); date_str = f"{vid_date} " if vid_date else ""; all_urls.append(f"[{cname}] {date_str}{title}:{link}")
                            ...
                            for pdf in assignments:
                                ...
                                pdf_date = extract_date(pdf); date_str = f"{pdf_date} " if pdf_date else ""; all_urls.append(f"[{cname}] {date_str}{title}:{link}")
